app.controller("HealthSettingsController", ['$scope', 'ChromeStorageService', 'AvoidInputKeysService', function($scope, ChromeStorageService, AvoidInputKeysService) {
